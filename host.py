...
class ContainerHost(Host):
    """A Host subclass that executes commands inside a container."""
...
def find_minc_container() -> str:
    """Find MINC (MicroShift IN Containers) automatically"""
...
def MincHost(container_name: Optional[str] = None) -> ContainerHost:
    """Factory function to create a ContainerHost for MINC containers"""
